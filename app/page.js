  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-white to-gray-100">
      <motion.div
        ...
        className="text-center p-8 max-w-2xl rounded-xl bg-white shadow-lg"
      >
        <motion.div
        ...
        >
          ...
          >
            <path d="M14.25 6.75L14.25 2.75M9.75 6.75V2.75M7.5 10.75h9M6.75 21.25h10.5c1.14 0 2 -.86 2-2V8.75c0-1.14-.86-2-2-2H6.75c-1.14 0-2 .86-2 2v10.5c0 1.14.86 2 2 2z" 
                  strokeWidth="1.5" 
                  strokeLinecap="round" 
        ...
        <p className="text-gray-500 mt-6">
          Check back soon to see our new design
        </p>
        <p className="text-gray-500 mt-6">
          Feel free to check out our other pages while we work on this one.
        </p>
