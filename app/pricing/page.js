...
//       <motion.div className="flex flex-col gap-[40px] my-[70px]"
...
//               Small businesses
//             </p>
//             <p className="font-inter text-[20px] sm:text-[22px] md:text-[24px]">
...
//           <mdiv className="flex flex-col gap-[15px] sm:gap-[20px] md:gap-[27px]">
