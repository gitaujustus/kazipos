    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-6 w-full md:max-w-[493px] 2xl:max-w-[700px] text-center md:text-left">
                <h3 className="font-inter font-medium text-2xl sm:text-3xl md:text-[36px] 2xl:text-[48px] leading-snug md:leading-[120%]">
                    {title}
                </h3>
                <p className="font-inter text-base sm:text-lg md:text-[18px] 2xl:text-[20px] leading-relaxed md:leading-[32px] 2xl:leading-[36px]">
                    {description}
                </p>
            </div>
